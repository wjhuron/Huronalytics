...
var Aggregator = {
  ...
  _aggregatePitcher: function (filters) {
    ...
    var boxFields = ['g', 'gs', 'ip', 'w', 'l', 'sv', 'hld', 'tbf', 'era', 'whip', 'hr9', 'runValue', 'rv100',
                     'era_pctl', 'whip_pctl', 'hr9_pctl', 'runValue_pctl', 'rv100_pctl', 'fip', 'fip_pctl', 'xFIP', 'xFIP_pctl', 'siera', 'siera_pctl',
