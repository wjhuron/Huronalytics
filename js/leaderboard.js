const COLUMNS = {
  pitchMetrics: [
    ...
    { key: 'pitchingScore', label: 'Pitching+', format: Utils.formatInt, sortType: 'numeric', desc: 'Pitching+ for this pitch type — overall pitch quality: 70% Stuff+ / 30% Loc+ (weights validated on future run prevention), re-standardized within the pitch type. 100 = group avg, +10 = 1 SD better.', group: 'outcomes' },
  ...
  pitcherStats: [
    ...
    { key: 'pitchingScore', label: 'Pitching+', format: Utils.formatInt, sortType: 'numeric', desc: 'Pitching+ — overall arsenal quality: 70% Stuff+ / 30% Loc+ (weights validated on future run prevention), re-standardized so 100 = league avg, +10 = 1 SD better.', group: 'run_value' },
...
const Leaderboard = {
  ...
  _TAB_HIDDEN_DEFAULTS: {
    pitchMetrics:       ['maxVelo', 'relPosZ', 'relPosX', 'xBA', 'xSLG'],
