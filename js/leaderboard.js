var COLUMNS = {
  pitchMetrics: [
    ...
    { key: 'ivbOE',       label: 'IVBOE',    format: Utils.formatSignedDecimal(1), sortType: 'numeric', noPercentile: true, group: 'metrics' },
    ...
    { key: 'hbOE',        label: 'HBOE',     format: Utils.formatSignedDecimal(1), sortType: 'numeric', noPercentile: true, group: 'metrics' },
