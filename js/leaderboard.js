const COLUMNS = {
  pitchMetrics: [
    ...
    { key: 'spinEff',     label: 'SpinEff%', format: Utils.formatDecimal(1), sortType: 'numeric', desc: 'Spin efficiency — pct of spin generating movement (Nathan model)', group: 'metrics' },
